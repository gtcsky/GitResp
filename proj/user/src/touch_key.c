...
{
    osal_start_timerEx(command_center_TaskID, GPIO_TIMER_KEY_EVT, intval_ms);
    return 0;
}
//static int key_timer_stop(void)
//{
//  osal_stop_timerEx(bleSmartPeripheral_TaskID, TIMER_KEY_EVT);
//  return 0;
//}
